...
export interface ApiActivityActivity extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Start/stop event of a colaborator on a subtask';
  ...
  attributes: {
    action: Schema.Attribute.Enumeration<['started', 'stoped']> &
      Schema.Attribute.Required;
    colaborator: Schema.Attribute.Relation<
      'manyToOne',
...
export interface ApiAwardAward extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Real-world prize redeemable with currency';
    displayName: 'Award';
    pluralName: 'awards';
    singularName: 'award';
  };
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    Value: Schema.Attribute.Component<'currency-values.values', true>;
    warnings: Schema.Attribute.Text;
  };
}
...
export interface ApiBalanceBalance extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Monthly currency balance per user (dated to day 1)';
    displayName: 'Balance';
    pluralName: 'balances';
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    previousBalance: Schema.Attribute.Decimal & Schema.Attribute.DefaultTo<0>;
    publishedAt: Schema.Attribute.DateTime;
    totalIncome: Schema.Attribute.Decimal & Schema.Attribute.DefaultTo<0>;
    totalOutcome: Schema.Attribute.Decimal & Schema.Attribute.DefaultTo<0>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiCurrencyCurrency extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'In-app currency (e.g. Estrela) and its earn rate';
  ...
  attributes: {
    ...
    name: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
    pluralTitle: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    title: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiExchangeExchange extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'A redemption of currency for an award';
  ...
  attributes: {
    award: Schema.Attribute.Relation<'manyToOne', 'api::award.award'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    ...
    user: Schema.Attribute.Relation<
      ...
      'plugin::users-permissions.user'
    >;
    value: Schema.Attribute.Component<'currency-values.values', false>;
  };
}
...
export interface ApiStepStep extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Kanban column / production stage';
    displayName: 'Step';
    pluralName: 'steps';
    singularName: 'step';
  };
...
export interface ApiSubTaskSubTask extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Unit of work assigned to colaborators; source of Stars';
    displayName: 'SubTask';
  ...
  attributes: {
    activationStatus: Schema.Attribute.Enumeration<
    ...
    expectedTime: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    index: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::sub-task.sub-task'
    > &
      Schema.Attribute.Private;
    maxSameTimeWorkers: Schema.Attribute.Integer &
    ...
    publishedAt: Schema.Attribute.DateTime;
    qty: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<1>;
    reasonForDisabling: Schema.Attribute.Text;
    sharingType: Schema.Attribute.Enumeration<['qty', 'duration']> &
...
export interface ApiTaskTask extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Production task moving across kanban steps';
    displayName: 'Task';
    pluralName: 'tasks';
    singularName: 'task';
  };
  ...
  attributes: {
    ...
    totalExpectedTime: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    totalTimeSpent: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiTeamTeam extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Production team with a leader and colaborators';
    displayName: 'Team';
    pluralName: 'teams';
    singularName: 'team';
  };
  ...
  attributes: {
    colaborators: Schema.Attribute.Relation<
      'manyToMany',
      'plugin::users-permissions.user'
    >;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    exchangesFirstDay: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<3>;
    exchangesLastDay: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<15>;
...
export interface ApiTemplateTaskTemplateTask
  extends Struct.CollectionTypeSchema {
  collectionName: 'template_tasks';
  info: {
    description: 'Reusable task blueprint with predefined subtasks';
    displayName: 'TemplateTask';
    pluralName: 'template-tasks';
    singularName: 'template-task';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::template-task.template-task'
    > &
      Schema.Attribute.Private;
    name: Schema.Attribute.String & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    subTask: Schema.Attribute.Component<'template.subtask', true>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    faceVector: Schema.Attribute.JSON;
    ...
    userTag: Schema.Attribute.String & Schema.Attribute.Unique;
  };
}
